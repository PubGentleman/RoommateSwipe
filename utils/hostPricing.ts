...
export const BOOST_OPTIONS = [
  ...
  },
  {
    ...
    price: 4.99,
    description: 'Top placement, Featured badge & impression tracking for 12 hours',
  ...
  },
  {
    ...
    price: 7.99,
    description: 'All Standard perks + Top Picks placement & full analytics dashboard for 24 hours',
    includesFeaturedBadge: true,
    badgeLabel: 'Featured' as string | null,
    highlight: false,
