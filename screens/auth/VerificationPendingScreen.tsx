...
export const VerificationPendingScreen: React.FC<Props> = ({ email, onVerified, onBackToLogin }) => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + 40, paddingBottom: insets.bottom + 20 }]}>
      ...
      <Pressable
        ...
        style={{ opacity: resendCooldown > 0 ? 0.5 : 1, width: '100%' }}
      >
        <LinearGradient
      ...
      <Pressable onPress={handleOpenEmail} style={styles.secondaryBtn}>
        <Feather name="external-link" size={16} color="#ff6b5b" />
        <Text style={styles.secondaryBtnText}>Open Email App</Text>
      </Pressable>

      <Text style={styles.hintText}>
        {"Didn't get it? Check spam or "}
        <Text style={styles.linkText} onPress={handleBackToLogin}>try a different email</Text>
      </Text>

      <Pressable onPress={handleBackToLogin} style={styles.backBtn} hitSlop={8}>
