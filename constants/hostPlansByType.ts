...
const AGENT_PLANS: HostPlanTier[] = [
  {
    ...
    features: [
      ...
      { label: 'Compatibility Matrix', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Compatibility Matrix (5 views/mo)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Compatibility Matrix', included: true },
...
const COMPANY_PLANS: HostPlanTier[] = [
  {
    ...
    features: [
      ...
      { label: 'Basic inquiry management', included: true },
      { label: 'Standard placement in search', included: true },
      { label: 'Agent management', included: false },
  ...
  },
  {
    ...
    annualPrice: 1910.40,
    monthlyNote: 'For small brokerages and property management companies',
    features: [
      { label: 'Up to 25 active listings', included: true },
      { label: 'Up to 3 agents under your account', included: true },
      { label: 'AI-powered renter matching', included: true },
      { label: 'Compatibility Matrix (5 views/mo)', included: true },
      { label: 'Background check access', included: true },
      { label: 'Company profile & branding', included: true },
      { label: 'Assign agents to listings', included: true },
    ],
  },
  {
    id: 'company_pro',
    ...
    annualPrice: 3830.40,
    recommended: true,
    monthlyNote: 'For growing brokerages with active agent teams',
    features: [
      { label: 'Up to 100 active listings', included: true },
      { label: 'Up to 10 agents under your account', included: true },
      { label: 'Priority listing placement', included: true },
      { label: 'Compatibility Matrix', included: true },
      { label: 'Bulk background checks', included: true },
      { label: 'Advanced analytics & agent performance', included: true },
      { label: 'Priority support', included: true },
    ],
  },
  {
    ...
    annualPrice: 0,
    isContactSales: true,
    monthlyNote: 'Custom pricing for large brokerages',
    features: [
      { label: 'Unlimited active listings', included: true },
