export type HostPlan = 'free' | 'none' | 'starter' | 'pro' | 'business'
  | 'agent_starter' | 'agent_pro' | 'agent_business'
...
export const PLAN_LIMITS: Record<string, PlanLimits> = {
  ...
  agent_business: {
    ...
    price: '$149/mo',
    maxListings: -1,
    proactiveOutreachPerDay: 20,
    proactiveOutreachPerHour: 5,
    groupCooldownDays: 30,
    canPayToUnlock: true,
    groupProfileAccess: 'full',
    listingPlacement: 'featured',
  ...
  company_enterprise: {
    ...
    price: 'Custom',
    maxListings: -1,
    proactiveOutreachPerDay: -1,
    proactiveOutreachPerHour: -1,
    groupCooldownDays: 30,
    canPayToUnlock: true,
    groupProfileAccess: 'full',
    listingPlacement: 'featured',
