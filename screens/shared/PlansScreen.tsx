...
const PLAN_FEATURES_ROOMMATE: Record<RenterPlan, { icon: string; label: string }[]> = {
  free: [
    ...
    { icon: 'cpu', label: 'Pi general advice (unlimited)' },
    { icon: 'user-check', label: 'Pi compatibility checks (3/day)' },
  ],
  plus: [
    ...
    { icon: 'cpu', label: 'Unlimited Pi matching' },
  ...
  elite: [
    ...
    { icon: 'cpu', label: 'Unlimited Pi — all modes' },
