...
const PRODUCTS: ProductConfig[] = [
  { identifier: "rhome_plus_monthly", playStoreIdentifier: "rhome_plus_monthly:monthly", displayName: "Plus Monthly", title: "Rhome Plus Monthly", duration: "P1M", priceMicros: 9990000, entitlement: "plus", packageKey: "$rc_monthly", packageDisplay: "Plus Monthly" },
  { identifier: "rhome_plus_3month", playStoreIdentifier: "rhome_plus_3month:three-month", displayName: "Plus 3 Month", title: "Rhome Plus 3 Month", duration: "P3M", priceMicros: 24990000, entitlement: "plus", packageKey: "$rc_three_month", packageDisplay: "Plus 3 Month" },
  { identifier: "rhome_plus_annual", playStoreIdentifier: "rhome_plus_annual:annual", displayName: "Plus Annual", title: "Rhome Plus Annual", duration: "P1Y", priceMicros: 79990000, entitlement: "plus", packageKey: "$rc_annual", packageDisplay: "Plus Annual" },
  { identifier: "rhome_elite_monthly", playStoreIdentifier: "rhome_elite_monthly:monthly", displayName: "Elite Monthly", title: "Rhome Elite Monthly", duration: "P1M", priceMicros: 19990000, entitlement: "elite", packageKey: "$rc_monthly", packageDisplay: "Elite Monthly" },
  { identifier: "rhome_elite_3month", playStoreIdentifier: "rhome_elite_3month:three-month", displayName: "Elite 3 Month", title: "Rhome Elite 3 Month", duration: "P3M", priceMicros: 49990000, entitlement: "elite", packageKey: "$rc_three_month", packageDisplay: "Elite 3 Month" },
  { identifier: "rhome_elite_annual", playStoreIdentifier: "rhome_elite_annual:annual", displayName: "Elite Annual", title: "Rhome Elite Annual", duration: "P1Y", priceMicros: 149990000, entitlement: "elite", packageKey: "$rc_annual", packageDisplay: "Elite Annual" },
