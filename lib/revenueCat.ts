...
const RC_PRODUCT_TO_PLAN: Record<string, { plan: string; billingCycle: 'monthly' | '3month' | 'annual'; planType: 'renter' | 'host' }> = {
  ...
  rhome_agent_starter_3month: { plan: 'agent_starter', billingCycle: '3month', planType: 'host' },
  rhome_agent_starter_annual: { plan: 'agent_starter', billingCycle: 'annual', planType: 'host' },
  rhome_agent_pro_monthly: { plan: 'agent_pro', billingCycle: 'monthly', planType: 'host' },
  rhome_agent_pro_3month: { plan: 'agent_pro', billingCycle: '3month', planType: 'host' },
  rhome_agent_pro_annual: { plan: 'agent_pro', billingCycle: 'annual', planType: 'host' },
  rhome_agent_business_monthly: { plan: 'agent_business', billingCycle: 'monthly', planType: 'host' },
  rhome_agent_business_3month: { plan: 'agent_business', billingCycle: '3month', planType: 'host' },
  rhome_agent_business_annual: { plan: 'agent_business', billingCycle: 'annual', planType: 'host' },
  rhome_company_starter_monthly: { plan: 'company_starter', billingCycle: 'monthly', planType: 'host' },
  rhome_company_starter_3month: { plan: 'company_starter', billingCycle: '3month', planType: 'host' },
  rhome_company_starter_annual: { plan: 'company_starter', billingCycle: 'annual', planType: 'host' },
  rhome_company_pro_monthly: { plan: 'company_pro', billingCycle: 'monthly', planType: 'host' },
  rhome_company_pro_3month: { plan: 'company_pro', billingCycle: '3month', planType: 'host' },
  rhome_company_pro_annual: { plan: 'company_pro', billingCycle: 'annual', planType: 'host' },
  ...
  rhome_host_starter_3month: { plan: 'starter', billingCycle: '3month', planType: 'host' },
  rhome_host_starter_annual: { plan: 'starter', billingCycle: 'annual', planType: 'host' },
  rhome_host_pro_3month: { plan: 'pro', billingCycle: '3month', planType: 'host' },
  rhome_host_pro_annual: { plan: 'pro', billingCycle: 'annual', planType: 'host' },
  rhome_host_business_3month: { plan: 'business', billingCycle: '3month', planType: 'host' },
  rhome_host_business_annual: { plan: 'business', billingCycle: 'annual', planType: 'host' },
};
