  ...
  return [
    {
      ...
      unread: 2,
      messages: [
        { id: 'hm1a', senderId: '1', text: 'Hi! I\'m very interested in the listing.', content: 'Hi! I\'m very interested in the listing.', timestamp: new Date(now - 1000 * 60 * 60 * 2).toISOString() },
        { id: 'hm1b', senderId: hostId, text: 'Thanks for your interest! The apartment is available for viewing.', content: 'Thanks for your interest! The apartment is available for viewing.', timestamp: new Date(now - 1000 * 60 * 60).toISOString() },
        { id: 'hm1c', senderId: '1', text: 'Can I schedule a viewing for this weekend?', content: 'Can I schedule a viewing for this weekend?', timestamp: new Date(now - 1000 * 60 * 20).toISOString() },
      ],
    ...
    },
    {
      ...
      unread: 1,
      messages: [
        { id: 'hm2a', senderId: '2', text: 'Hello! I saw your listing and have a few questions.', content: 'Hello! I saw your listing and have a few questions.', timestamp: new Date(now - 1000 * 60 * 60 * 6).toISOString() },
        { id: 'hm2b', senderId: hostId, text: 'Of course, happy to answer any questions!', content: 'Of course, happy to answer any questions!', timestamp: new Date(now - 1000 * 60 * 60 * 5).toISOString() },
        { id: 'hm2c', senderId: '2', text: 'Is the apartment pet-friendly?', content: 'Is the apartment pet-friendly?', timestamp: new Date(now - 1000 * 60 * 60 * 4).toISOString() },
      ],
      isInquiryThread: true,
    ...
    },
    {
      ...
      unread: 0,
      messages: [
        { id: 'hm3a', senderId: '3', text: 'Hi, I loved the apartment during my visit!', content: 'Hi, I loved the apartment during my visit!', timestamp: new Date(now - 1000 * 60 * 60 * 24).toISOString() },
        { id: 'hm3b', senderId: hostId, text: 'Great to hear! I can send you the lease agreement.', content: 'Great to hear! I can send you the lease agreement.', timestamp: new Date(now - 1000 * 60 * 60 * 20).toISOString() },
        { id: 'hm3c', senderId: '3', text: 'The lease terms work for me. When can I sign?', content: 'The lease terms work for me. When can I sign?', timestamp: new Date(now - 1000 * 60 * 60 * 10).toISOString() },
      ],
      isInquiryThread: true,
      inquiryStatus: 'accepted',
      hostId,
